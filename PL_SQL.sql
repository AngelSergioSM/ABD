...
--RF4
  ...
  PROCEDURE AGREGARAUTORIZADO(PA_ID PERSONA_AUTORIZADA.ID%TYPE,
	...
	BEGIN
		...
		IF (X_PA = 0) THEN
			INSERT INTO PERSONA_AUTORIZADA(ID, IDENTIFICACION, NOMBRE, APELLIDOS, DIRECCION,FECHA_INICIO)
			VALUES (PA_ID, PA_IDENT, PA_NOMBRE, PA_APELLIDOS, PA_DIR, CURRENT_DATE);
